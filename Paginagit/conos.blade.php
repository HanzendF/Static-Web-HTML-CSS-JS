        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">Conos Aromaticos</li>
                </ul>
            </div>
        </div>
    </div>
...
<main id="main">
            ...
            <div class="product-detail__container">
                    ...
                    <div class="details__container--left">
                        <div class="product__pictures">
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/conos/cono.jpg" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/conos/cono2.jpg" id="pic2" />
                            </div>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src="./images/products/conos/cono.jpg" id="pic" />
                            </div>
                        </div>
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        <h3>Conos Aromaticos</h3>
                        <div class="price">
                            <span class="new__price">$100</span>
                        </div>
                        <p>
                            ¡Conos Aromaticos para ambientar todo tipo de departamentos, casas, negocios etc.. hecho
                            con las mas finas especias y traido directamente desde la india!
                        </p>
                            ...
                            <ul class="product__info">
                                <li class="select">
                                    <div class="select__option">
                                        ...
                                        <select name="colors" id="aroma" class="select-box">
                                            <option value="lavandac">lavanda</option>
                                            <option value="rosac">Rosa</option>
                                            <option value="sandaloc">sandalo</option>
                                            <option value="eucaliptoc">eucalipto</option>
                        ...
                        <span class="minus-btn">
                          ...
                          <svg>
                            <use xlink:href="./images/sprite.svg#icon-plus"></use>
                                ...
                                <li>
                                    <span>Subtotal:</span>
                                    <a href="#" class="new__price">$100</a>
                                </li>
                                <li>
                                    <span>Marca:</span>
                                    <a href="#">Tribal Soul</a>
                                </li>
                                <li>
                                    <span>Tipo de producto:</span>
                                    <a href="#">Conitos Aromaticos</a>
                                </li>
                                <li>
    ...
    <!-- Custom JavaScript -->
    <script src="./js/productos%20js/cono.js"></script>
