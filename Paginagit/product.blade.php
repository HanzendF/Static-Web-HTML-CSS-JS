        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">Sahumerios Sagrada Madre</li>
                </ul>
            </div>
        </div>
    </div>
...
<main id="main">
            ...
            <div class="product-detail__container">
                    ...
                    <div class="details__container--left">
                        <div class="product__pictures">
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sagrada/sagrada1.jpg" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sagrada/sagrada2.jpg" id="pic2" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sagrada/sagrada3.jpg" id="pic3" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sagrada/sagrada4.jpg" id="pic4" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sagrada/sagrada5.jpg" id="pic5" />
                            </div>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src="./images/products/sagrada/sagrada.jpg" id="pic" />
                            </div>
                        </div>
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        <h3>Sahumerios Linea Sagrada Madre</h3>
                        <div class="price">
                            <span class="new__price">$350</span>
                        </div>
                        <p>
                            El suave aroma de estos sahumerios ha sido considerado desde la antigüedad como
                            “ la puerta de entrada a lo sagrado”. Se dice que esta mezcla de resinas sagradas que se usa para hacer
                            este sahumerio trae purificación y limpieza energética,
                            brindando paz y serenidad; un compañero
                            ideal para la meditación, rituales y ceremonias.
                                ...
                                <li class="select">
                                    <div class="select__option">
                                        ...
                                        <select name="colors" id="colors" class="select-box">
                                            ...
                                            <option value="incienso">Incienso Blanco</option>
                          ...
                          <svg>
                            <use xlink:href="./images/sprite.svg#icon-plus"></use>
                                ...
                                <li>
                                    ...
                                    <a href="#" class="in-stock">Stock (Quedan 7)</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="glide__track" data-glide-el="track">
                            <ul class="glide__slides latest-center">
                                ...
                                <li class="glide__slide">
                                    <div class="product">
                                        <div class="product__header">
                                            <a href="velon.blade.php"><img src="images/products/interes/velon.jpg" alt="product"></a>
                                        </div>
                                        <div class="product__footer">
                                            <h3>Velon Blanco</h3>
                                            <div class="product__price">
                                ...
                                <li class="glide__slide">
                                    <div class="product">
                                        <div class="product__header">
                                            <a href="#"><img src="images/products/interes/aceite2.png" alt="product"></a>
                                        </div>
                                        <div class="product__footer">
    ...
    <!-- Custom JavaScript -->
    <script src="./js/productos%20js/products.js"></script>
