        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">Velas 100% Parafina</li>
                </ul>
            </div>
        </div>
    </div>
...
<main id="main">
            ...
            <div class="product-detail__container">
                    ...
                    <div class="details__container--left">
                        <div class="product__pictures">
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/velas/velas1.jpg" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/velas/velas2.jpg" id="pic2" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/velas/velas3.jpg" id="pic3" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/velas/velas4.jpg" id="pic4" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/velas/velas5.jpg" id="pic5" />
                            </div>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src="./images/products/velas/velaportada.jpg" id="pic" />
                            </div>
                        </div>
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        <h3>Velas Largas x100 unidades</h3>
                        <div class="price">
                            <span class="new__price">$2500</span>
                        </div>
                        <p>
                            Somos fabricantes y nuestros productos los elaboramos con 100% parafina de la más alta
                            calidad. Totalmente alquimizadas y perfectas para todo tipo de rituales, sanaciones etc..
                        </p>
                        ...
                        <span class="minus-btn">
                          ...
                          <svg>
                            <use xlink:href="./images/sprite.svg#icon-plus"></use>
                                ...
                                <li>
                                    <span>Subtotal:</span>
                                    <a href="#" class="new__price">$2500</a>
                                </li>
                                <li>
                                    <span>Marca:</span>
                                    <a href="#">Lluvia del Plata</a>
                                </li>
                                <li>
                                    <span>Tipo de producto:</span>
                                    <a href="#">Velas x100 u </a>
                                </li>
                                <li>
    ...
    <!-- Custom JavaScript -->
    <script src="./js/productos%20js/velas.js"></script>
