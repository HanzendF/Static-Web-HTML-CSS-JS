        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">Sahumerios</li>
                </ul>
            </div>
        </div>
    </div>
...
<main id="main">
            ...
            <div class="product-detail__container">
                    ...
                    <div class="details__container--left">
                        <div class="product__pictures">
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sahumos/santo1.jpg" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sahumos/santo2.jpg" id="pic2" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sahumos/santo3.jpg" id="pic3" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sahumos/santo4.jpg" id="pic4" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/sahumos/santo5.jpg" id="pic5" />
                            </div>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src="./images/products/sahumos/santo2.jpg" id="pic" />
                            </div>
                        </div>
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        <h3>Sahumerios Palo santo</h3>
                        <div class="price">
                            <span class="new__price">$300</span>
                        </div>
                        <p>
                            Sahumerios hechos con la madera 100% reciclada del arbol de palo santo, propiedades muy
                            aromaticas y perfectas para limpieza del hogar y eliminar malos espiritus.
                        </p>
                                ...
                                <li class="select">
                                    <div class="select__option">
                                        ...
                                        <select name="colors" id="colors" class="select-box">
                                            <option value="Psanto">Palo santo</option>
                                            <option value="Psandalo">Palo santo con sandalo</option>
                                            <option value="Pmirra">Palo santo con Mirra</option>
                                            <option value="Promero">Palo santo con Romero</option>
                                            <option value="Pjazmin">Palo santo con Jazmin</option>
    ...
    <!-- Custom JavaScript -->
    <script src="./js/productos%20js/sagrada.js"></script>
