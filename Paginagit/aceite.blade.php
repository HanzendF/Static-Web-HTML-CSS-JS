        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">Aceites Escenciales</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="product-detail__container">
                    ...
                    <div class="details__container--left">
                        <div class="product__pictures">
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/aceites/aceite1.png" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/aceites/aceite2.png" id="pic2" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/aceites/aceite3.png" id="pic3" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/aceites/aceite4.png" id="pic4" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/aceites/aceite5.png" id="pic5" />
                            </div>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src="./images/products/aceites/aceiteportada.png" id="pic" />
                            </div>
                        </div>
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        ...
                        <div class="price">
                            <span class="new__price">$250</span>
                        </div>
                        <p>
                            Aceite Escencial de 10 ML para fabricar velas, shampoos, etc.. Tambien para masajes medicinales
                            o relajantes 100% naturales.
                        </p>
                                ...
                                <li class="select">
                                    <div class="select__option">
                                        ...
                                        <select name="colors" id="colors" class="select-box">
                                            ...
                                            <option value="rosa">Rosa Mosqueta</option>
                        ...
                        <span class="minus-btn">
                          ...
                          <svg>
                            <use xlink:href="./images/sprite.svg#icon-plus"></use>
                                ...
                                <li>
                                    <span>Subtotal:</span>
                                    <a href="#" class="new__price">$250</a>
                                </li>
                                <li>
                                    <span>Marca:</span>
                                    <a href="#">Aromas del Alto Valle</a>
                                </li>
                                <li>
                                    <span>Tipo de producto:</span>
                                    <a href="#">Aceite Escencial </a>
                                </li>
                                <li>
