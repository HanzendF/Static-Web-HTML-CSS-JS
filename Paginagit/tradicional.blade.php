        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">Sahumerios tradicionales chinos</li>
                </ul>
            </div>
        </div>
    </div>
...
<main id="main">
            ...
            <div class="product-detail__container">
                    ...
                    <div class="details__container--left">
                        <div class="product__pictures">
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/chino/incienso1.jpg" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="./images/products/chino/incienso2.jpg" id="pic2" />
                            </div>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src="./images/products/chino/incienso1.jpg" id="pic" />
                            </div>
                        </div>
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        ...
                        <p>
                            Sahumerios tradicionales con poco humo y aroma a sandalo para meditar y relajarse.
                        </p>
                                ...
                                <li class="select">
                                    <div class="select__option">
                                        ...
                                        <select name="colors" id="aroma" class="select-box">
                                            <option value="chinosandalo">sandalo</option>
                                        </select>
                                    </div>
                        ...
                        <span class="minus-btn">
                          ...
                          <svg>
                            <use xlink:href="./images/sprite.svg#icon-plus"></use>
                                ...
                                <li>
                                    <span>Subtotal:</span>
                                    <a href="#" class="new__price">$500</a>
                                </li>
                                <li>
                                    <span>Marca:</span>
                                    <a href="#">Xinyan MeinFang</a>
                                </li>
                                <li>
                                    <span>Tipo de producto:</span>
                                    <a href="#">Sahumerios chinos</a>
                                </li>
                                <li>
    ...
    <!-- Custom JavaScript -->
    <script src="./js/productos%20js/tradicional.js"></script>
